...
For a practical non-ROS command-line client for first connection and motion
tests against an Omron robot over ArNetworking, see [doc/cli.md](doc/cli.md).
...
This repository now includes a standalone non-ROS command-line client for
connecting to an Omron robot over ArNetworking and exercising the same basic
operations used by the ROS 1 driver, without bringing up ROS.

See [doc/cli.md](doc/cli.md) for build, launch and command usage instructions.
